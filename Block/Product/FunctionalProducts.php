...
/**
 * Catalog functional products block
 */
class FunctionalProducts extends AbstractLinkProducts
{
    /**
    ...
    {
        return $this->getData('title') ?: __('Functional Products');
    }
}
